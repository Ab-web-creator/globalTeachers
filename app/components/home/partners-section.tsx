...
export default function PartnersSection() {
  return (
    <section data-reveal aria-labelledby="partners-title" className="mx-auto w-full max-w-400 px-6 pt-6 pb-10 sm:px-10 sm:pt-8 sm:pb-12 lg:py-20 xl:py-24 lg:px-16 xl:px-20">
