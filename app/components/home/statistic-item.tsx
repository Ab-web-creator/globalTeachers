...
export default function StatisticItem({ value, label }: StatisticItemProps) {
  return (
    <div data-reveal className="flex flex-col items-center justify-center gap-3 px-4 py-4 text-center sm:even:border-l sm:even:border-brand-100 lg:border-l lg:border-brand-100 lg:first:border-l-0">
