...
export default function Hero() {
  return (
    <div className="relative z-10 ml-auto max-w-3xl py-12 text-right sm:py-16 lg:py-24 xl:py-28">
      ...
      <p className="mt-6 ml-auto max-w-xl text-base leading-relaxed text-brand-50 sm:text-lg">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-end gap-3 sm:gap-4">
        <Link href="/consultation" className="inline-flex items-center justify-center gap-4 rounded-full bg-linear-to-r from-amber-200 to-orange-300 px-6 py-4 text-base font-semibold text-stone-900 transition hover:from-amber-300 hover:to-orange-400 hover:shadow-md">
