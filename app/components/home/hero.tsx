...
export default function Hero({ openPanel }: PanelProps) {
  return (
    <section className="py-2 lg:py-8" aria-labelledby="hero-title">
      <p className="mb-7 text-xs font-semibold tracking-widest text-[#00566b] sm:mb-9 sm:text-base">Добро пожаловать в Globalteacherhub</p>
      ...
      <div className="mt-9 flex flex-wrap gap-4 sm:mt-10 sm:gap-6">
        ...
        <PrimaryButton onClick={() => openPanel("Demo")}>Try Demo <span aria-hidden="true" className="text-2xl leading-none text-[#acd2dc]">→</span></PrimaryButton>
      </div>
      <StudentTrust />
    </section>
  );
