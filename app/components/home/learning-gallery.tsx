  ...
  return (
    <section aria-label="Learn together with Educine" className="grid grid-cols-2 grid-rows-[1.58fr_1fr] gap-4 sm:gap-6 lg:gap-7">
      ...
      <div className="relative row-span-2 overflow-hidden rounded-3xl bg-[#e7eae7]">
        ...
        <button onClick={() => openPanel("Demo")} aria-label="Open the Educine demo preview" className="absolute top-1/2 left-1/2 flex size-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-brand-100 transition hover:scale-105 hover:bg-white sm:size-22">
