...
export default function AboutCopy({ openPanel }: PanelProps) {
  return (
    <div className="px-6 py-2 sm:px-0 lg:py-4">
      <p className="mb-3 sm:mb-4 text-sm font-semibold tracking-widest text-brand-500 sm:text-base uppercase">О нас</p>
      <h2 id="about-title" className="text-4xl sm:text-5xl md:text-4xl xl:text-5xl 2xl:text-6xl leading-none font-semibold tracking-tight">
