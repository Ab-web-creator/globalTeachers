    ...
    <section id="categories" aria-labelledby="categories-title" className="bg-brand-50">
      <div className="mx-auto max-w-400 px-6 py-16 sm:px-10 sm:py-20 lg:px-16 lg:py-24 xl:px-20">
        <header className="text-center">
          ...
          <h2 id="categories-title" className="text-4xl sm:text-5xl md:text-4xl xl:text-5xl 2xl:text-6xl leading-tight font-semibold tracking-tight">Всё для вашей международной карьеры</h2>
        </header>
