...
export default function FooterContact() {
  return (
    <div id="footer-contact" className="relative col-span-2 w-full max-w-md overflow-hidden rounded-3xl border border-white/80 bg-white/95 text-brand-700 shadow-sm p-6 sm:p-7 lg:col-span-1">
      <svg viewBox="0 0 120 120" fill="none" stroke="currentColor" strokeWidth="1.5" className="pointer-events-none absolute -right-8 bottom-0 size-48 text-brand-400/15" aria-hidden="true">
      ...
      <div className="relative">
        ...
        <ul className="mt-5 space-y-4 text-base text-neutral-700 lg:text-sm">
